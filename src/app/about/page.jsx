                    ...
                    <div className="flex flex-col gap-12 justify-center pb-48">
                        ...
                        <div className="">
                            ...
                            <div className="flex justify-between h-48">
                                ...
                                <div className="w-1/3">
                                    {/* JOB TITLE */}
                                    <div className="bg-white p-3 font-semibold rounded-b-lg rounded-s-lg">Junior JavaScrpt Engineer</div>
                                    {/* JOB DESC */}
                                    <div className="p-3 text-sm italic">My postion before!</div>
                                    {/* JOB DATE */}
                                    <div className="p-3 text-red-400 text-sm font-semibold">2020 - 2024</div>
                                    {/* JOB COMPANY */}
                                    <div className="p-1 rounded bg-white text-sm font-semibold w-fit">QTS</div>
                                </div>
                            </div>
                            {/* EXPERIENCE LIST ITEM */}
                            <div className="flex justify-between h-48">
                                ...
                                <div className="w-1/3">
                                    {/* JOB TITLE */}
                                    <div className="bg-white p-3 font-semibold rounded-b-lg rounded-s-lg">JavaScript Engineer</div>
                                    {/* JOB DESC */}
                                    <div className="p-3 text-sm italic">Way back!</div>
                                    {/* JOB DATE */}
                                    <div className="p-3 text-red-400 text-sm font-semibold">2015 - 2020</div>
                                    {/* JOB COMPANY */}
                                    <div className="p-1 rounded bg-white text-sm font-semibold w-fit">Estes</div>
                                </div>
                                {/* CENTER */}
                                <div className="w-1/6 flex justify-center">
                                    {/* LINE */}
