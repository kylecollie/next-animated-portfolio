...
const Navbar = () =>
{
    ...
    return (
        <div className='h-full flex items-center justify-between px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48 text-xl'>
            ...
            {/* LOGO */}
            <div className='md:hidden lg:flex w-1/3 lg:justify-center'>
            ...
            <div className="hidden md:flex gap-4 w-1/3">
                ...
                <Link href={"#"}>
                    <Image src="/dribbble.png" alt="dribble logo" width={24} height={24} />
                </Link>
                <Link href={"#"}>
                ...
                <Link href={"#"}>
                    <Image src="/pinterest.png" alt="pinterest logo" width={24} height={24} />
                </Link>
                <Link href={"#"}>
            ...
            <div className='md:hidden'>
                ...
                {open && (
                    <div className="absolute top-0 left-0 w-screen h-screen bg-black text-white flex flex-col items-center justify-center gap-8 text-4xl">
                        {links.map((link) => (
                            <Link href={link.url} key={link.title} className="">{link.title}</Link>
                        ))}
                    </div>
                )}
            </div>
